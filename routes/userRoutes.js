...
userRoutes.get("/",requireAdmin,userController.getAllUsers.bind(userController));
...
userRoutes.put("/:id",requireAdmin,userController.updateUser.bind(userController));

userRoutes.delete("/:id",requireAdmin,userController.deleteUser.bind(userController));
